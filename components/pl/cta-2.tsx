...
export function CTA2() {
    return (
        <section id='cta-2' className='relative isolate py-16'>
            {/* Grid BG */}
                ...
                <div className='relative isolate overflow-hidden rounded-3xl bg-neutral-900 px-6 shadow-2xl sm:px-16 lg:px-24 lg:pt-0'>
                    ...
                    <div className='m-auto py-16 text-center'>
                        <h2 className='text-3xl font-bold tracking-tight sm:text-4xl'>
                            La programmazione mi ha cambiato la vita. <br /> Ora voglio cambiarla agli altri.
                        </h2>
                        <p className='m-auto mt-6 max-w-2xl text-lg leading-8 text-muted-foreground dark:text-neutral-300'>
                            Saper programmare mi ha permesso di trasformare un'idea in un'azienda, di essere contattato
                            da Google per un'offerta di lavoro e molto altro
                        </p>
                        <div className='mt-10 flex items-center justify-center gap-x-6'>
                            <CtaButton href='/programmatore-leggendario#pricing' text='Cambia la tua vita' />
                        </div>
                    </div>
                </div>
            </div>
