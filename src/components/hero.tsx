    ...
    return (
        <>
            <div className="-mt-24 flex min-h-screen flex-col md:justify-center">
                <div className="flex flex-col-reverse gap-8 pt-24 md:flex-row md:justify-between md:pt-0">
                    <div className="md:max-w-lg">
                        {/* Name */}
                        <h1 className="animate-fade-in text-5xl font-bold">Matteo Giardino</h1>

                        {/* Occupation and description */}
                        <div className="my-6 space-y-2">
                            <h2 className="space-x-2 font-medium leading-8">
                                Founder & CTO @{' '}
                                <a
                                    ...
                                    <Image
                                        ...
                                        width={24}
                                        height={24}
                                        className="-mt-1 mr-2 inline-block h-6 rounded border border-accent-3"
                                    />
                                    Westudents{' '}
                                </a>
                            ...
                            <p className="text-lg text-accent-5">
                                Un programmatore innamorato della tecnologia, un imprenditore innamorato delle idee e un
            ...
            <div className="absolute bottom-0 left-0 right-0 top-0 max-h-screen w-screen">
                ...
                <div className="absolute inset-0 bottom-0 left-auto right-0 top-auto -z-50 h-[40%] w-full bg-[url(/static/images/profile.png)] bg-contain bg-bottom bg-no-repeat [mask-image:linear-gradient(180deg,black,rgba(0,0,0,0))] md:h-full md:w-1/2"></div>
            </div>
        </>
    )
}
