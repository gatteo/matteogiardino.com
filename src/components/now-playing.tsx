    ...
    return (
        <div className="flex w-auto items-end overflow-hidden">
            ...
            <motion.span
                ...
                transition={{ duration: 1.5, repeat: Infinity }}
                className="mr-[3px] h-1 w-1 rounded-t-sm bg-gray-300 dark:bg-gray-500"
            />
            <motion.span
                animate={{
                    transform: [
                    ...
                    {data?.isPlaying ? (
                        <>
                            <a
                                ...
                                <span className="text-accent-5">In questo momento sto ascoltando </span>
                                {data.name}
                                <span className="text-accent-5"> - {data.artist}</span>
                            </a>
                        </>
                    ) : (
