...
import { Avatar, AvatarFallback, AvatarImage, Button, Textarea } from '@tszhong0411/ui'
    ...
    return (
        <>
            <div className="mb-2 flex gap-3">
                ...
                <Textarea placeholder="Your message ..." value={value} onChange={(e) => setValue(e.target.value)} />
            </div>
