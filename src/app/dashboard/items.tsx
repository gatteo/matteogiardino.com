...
import { IconBrandGithub, IconBrandYoutube, IconClock, IconPencil, IconUser } from '@tabler/icons-react'
...
const Items = () => {
    ...
    const getAge = () => (dayjs().diff('2006-04-11', 'milliseconds') / (365.25 * 24 * 60 * 60 * 1000)).toFixed(9)
    ...
    const data: Card[] = [
        {
            title: 'My Age',
            link: 'https://matteogiardino.com/about',
            value: age,
            icon: <IconUser />,
        },
        {
            title: 'Coding Hours',
            link: 'https://wakatime.com/@matteogiardino',
            value: wakatimeData?.seconds ? `${Math.round(wakatimeData.seconds / 60 / 60)} hrs` : undefined,
            icon: <IconClock />,
        },
        {
            title: 'YouTube Subscribers',
            link: 'https://youtube.com/@matteogiardino',
        ...
        },
        {
            ...
            link: 'https://github.com/matteogiardino',
