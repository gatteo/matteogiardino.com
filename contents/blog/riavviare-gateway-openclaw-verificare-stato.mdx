...
authorId: matteo
locale: 'it'
tags: ['openclaw', 'tutorial', 'developer tools', 'platforms']
translationSlug: 'restart-openclaw-gateway-verify-status'
---
...
**Il comando restart non risponde?**   (vedi anche [Come Aggiornare OpenClaw: Update, Downgrade e Errori Comuni](/blog/aggiornare-openclaw))
