...
translationSlug: 'nvidia-nemoclaw-openclaw-aziendale'
---
...
<Mermaid caption="The privacy router classifies each task and picks the right model - sensitive data never leaves the building">
{`
flowchart TB
  TASK["Incoming task"]
  CLASS{"Privacy<br/>classifier"}
  TASK --> CLASS
  CLASS -->|sensitive data| LOCAL["Local Nemotron<br/>on-prem hardware"]
  CLASS -->|non-sensitive| CLOUD["Cloud frontier API<br/>Claude / GPT / Gemini"]
  LOCAL --> RESP["Response"]
  CLOUD --> RESP
`}
</Mermaid>
