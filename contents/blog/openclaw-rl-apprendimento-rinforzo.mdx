...
authorId: matteo
locale: 'it'
tags: ['openclaw', 'ai', 'machine learning', 'ai agents']
translationSlug: 'openclaw-rl-reinforcement-learning'
---
...
<Mermaid caption="OpenClaw-RL: traffico chat e aggiornamenti dei gradienti girano in parallelo senza bloccarsi">
{`
flowchart LR
  Client["Client OpenClaw<br/>il tuo assistente"]
  Model["Model server<br/>API OpenAI :30000"]
  PRM["PRM server<br/>process reward model"]
  Train["Training engine<br/>aggiornamento gradienti"]

  Client <-->|conversazioni| Model
  Model -->|ogni turno| PRM
  PRM -->|reward scalare| Train
  Train -.->|nuovi pesi| Model
`}
</Mermaid>
