...
translationSlug: 'tinyclaw-clawrouter-routing-multi-agente'
---
...
<Mermaid caption="Each request is scored across 15 dimensions, then routed to the cheapest model that can handle it">
{`
flowchart TB
  REQ["Incoming request"]
  SCORE["ClawRouter<br/>15-dimension scoring &lt;1ms"]
  REQ --> SCORE
  SCORE -->|cheap + capable| ECO["Eco<br/>maximum savings"]
  SCORE -->|balanced workload| AUTO["Auto<br/>balanced performance"]
  SCORE -->|complex task| PREMIUM["Premium<br/>frontier model"]
  SCORE -->|no API key| FREE["Free<br/>GPT-OSS 120B fallback"]
`}
</Mermaid>
...
## Which One Should You Choose? (vedi anche [HiClaw: Run a Multi-Agent AI Team Locally with Ollama](/blog/hiclaw-multi-agent-team-locally)) (vedi anche [HiClaw: Run a Multi-Agent AI Team Locally with Ollama](/blog/hiclaw-multi-agent-team-locally))
