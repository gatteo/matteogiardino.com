...
<Mermaid caption="Lo stack AI locale 2026: specialisti deep contro la giocata wide di QVAC">
{`
flowchart TB
  subgraph deep["Vai in profondità su un asse"]
    L["llama.cpp<br/>inference"]
    O["Ollama<br/>ergonomia desktop"]
    M["MLX<br/>Apple Silicon"]
    T["transformers.js<br/>browser"]
  end
  subgraph wide["Vai in larghezza su tutti gli assi"]
    Q["QVAC SDK<br/>8 capacità · 4 runtime<br/>tutte le piattaforme · P2P"]
  end
  deep -.- wide
`}
</Mermaid>
 Se hai osservato [il passaggio dai chatbot agli agenti](/blog/da-chatbot-ad-agenti-2026) e hai notato quanto velocemente i prodotti reali iniziano ad aver bisogno di trascrizione + RAG + tool-use + generazione immagini in una sola app, capisci perché una risposta in forma di SDK era inevitabile.
