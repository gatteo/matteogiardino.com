---
title: 'Fish Audio S2 Pro: Local Voice Cloning Guide for 2026'
createdAt: '2026-03-26T00:00:00Z'
modifiedAt: '2026-03-26T00:00:00Z'
summary: 'Practical 2026 guide to Fish Audio S2 Pro for local text-to-speech voice cloning. Learn Ubuntu installation, CLI workflow, and real use cases.'
image: '/images/blog/fishaudio-s2-pro-local-voice-cloning.png'
authorId: matteo
locale: 'en'
tags: ['ai', 'machine learning', 'voice']
translationSlug: 'fishaudio-s2-pro-voice-cloning-locale'
---

*By Matteo Giardino*

If you want to run local voice cloning in 2026, Fish Audio S2 Pro is the open-source solution you need. Text-to-speech has always had one problem: it sounds flat. In most cases you can't tell if it's a machine or human. **Fish Audio S2 Pro** is trying to change that.

It's an open-weight TTS model you can run locally on your machine (perfect for [building an offline AI voice assistant](/blog/offline-ai-voice-assistant-openclaw-whisper)), trained on 10 million hours of audio across 80 languages. The key feature? You control exactly how the voice sounds by embedding tags directly in your text.
...
### What are the system requirements for Fish Audio S2 Pro in 2026?
You need an NVIDIA GPU with at least 8GB of VRAM to run the model comfortably, or a Mac with M-series chips and 16GB of Unified Memory.

### Does it work entirely offline?
Yes! Once downloaded, Fish Audio S2 Pro does not require any internet connection, ensuring complete privacy for your voice cloning tasks.

### Can I integrate it with OpenClaw?
Absolutely. Fish Audio S2 Pro integrates seamlessly with local AI frameworks like OpenClaw via their HTTP API servers.
