---
title: 'strangeClaw: The Sandboxed OpenClaw microVM Alternative'
...
By default, this ensures the agent has zero access to your host filesystem, unlike standard [OpenClaw](/blog/openclaw-vs-apple-intelligence) which has direct access.
...
**What makes strangeClaw different from OpenClaw?**
strangeClaw runs inside a Firecracker microVM, giving it zero direct access to your host OS, preventing catastrophic file deletion or credential theft. 

**Does strangeClaw run on Mac Mini?**
Yes, it runs perfectly on local servers like a [Mac Mini](/blog/server-ai-locale-mac-mini-openclaw).

**Is performance affected by the microVM?**
Firecracker microVMs boot in less than 125 milliseconds. The performance overhead is negligible, typically under 2% compared to native execution.


_Matteo Giardino is a fractional CTO who builds secure local AI agent architectures._