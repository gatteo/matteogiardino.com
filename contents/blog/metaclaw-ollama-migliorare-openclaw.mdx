...
authorId: matteo
locale: 'it'
tags: ['openclaw', 'llm', 'ai agents', 'machine learning', 'automation']
translationSlug: 'metaclaw-ollama-make-openclaw-smarter'
---
...
Il bello di usare Ollama è che **tutto rimane locale** e non paghi chiamate API, nemmeno quando l'agente esegue una [chiamata strumento ollama](/blog/configurare-openclaw-ollama-agenti-ai-locali). Questo è quello che uso io.
